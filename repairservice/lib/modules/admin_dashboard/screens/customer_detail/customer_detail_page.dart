              ...
              children: [
                ...
                Expanded(
                    ...
                    child: PostDetailButton(
                      ...
                      title: status == 1 ? "Khóa tài khoản" : "Mở tài khoản",
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            title:
                                status == 1 ? "Khóa tài khoản" : "Mở tài khoản",
                            textColor: Colors.white,
                            icon: Container(),
                          )),
                        ),
      ...
      child: Column(
        children: [
          ...
          Item(
              icon: Icon(Icons.email),
              title: "Trạng thái ",
              text: status == 1 ? "đã kích hoạt" : "đã bị khóa",
              colorsub: status == 1 ? Colors.blue : Colors.red),
          Container(
            height: kDefaultPadding,
          ),
          SizedBox(
